...
<ul class="nav navbar-nav navbar-right">
        ...
        <div class="container">
            ...
            <asp:Calendar ID="Calendar1" runat="server"
                ...
                <TodayDayStyle BackColor="#99CCCC" ForeColor="whitesmoke" />
                <SelectorStyle BackColor="#99CCCC" ForeColor="#336666" />
                <WeekendDayStyle BackColor="antiquewhite" />
                <OtherMonthDayStyle ForeColor="#999999" />
                <NextPrevStyle Font-Size="8pt" ForeColor="#222222" />
                <DayHeaderStyle BackColor="#222222" BorderColor="#222222" BorderWidth="1px" ForeColor="whitesmoke" Height="3px" HorizontalAlign="Center" Font-Size="Medium" />
                <TitleStyle BackColor="antiquewhite" BorderColor="#222222"
                BorderWidth="1px" Font-Bold="True"
                Font-Size="Medium" ForeColor="#22222" HorizontalAlign="Center" Height="25px" />
            </asp:Calendar></center></div>
            <br />
            <center><asp:GridView ID="GridView1" cellpadding="10" cellspacing="5" runat="server" >
            </asp:GridView></center>
            <br />
            <asp:Label CssClass="label" ID="Label4" runat="server" Text="Class"></asp:Label>
            <br />
            <asp:TextBox CssClass="tb" ID="TextBox2" runat="server"></asp:TextBox>
            <br />
            <asp:Label CssClass="label" ID="Label5" runat="server" Text="Notes"></asp:Label>
            <br />
            <asp:TextBox CssClass="tb" ID="TextBox3" runat="server"></asp:TextBox>
            <br />
            <asp:Label CssClass="label" ID="Label6" runat="server" Text="Date"></asp:Label>
            <br />
            <asp:TextBox CssClass="tb" ID="TextBox4" runat="server"></asp:TextBox>
            <br />
            <asp:Button class="btn" ID="Button1" runat="server" Text="Add New Note" OnClick="Button1_Click"/>
            <br />
